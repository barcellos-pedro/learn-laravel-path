        ...
        <main class="max-w-lg mx-auto mt-10">
            ...
            <form action="/register" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="name" id="name" class="border border-gray-400 p-2 w-full rounded" required maxlength="255" value="{{ old('name') }}">
                    @error('name')
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="username" id="username" class="border border-gray-400 p-2 w-full rounded" required minlength="3" maxlength="255" value="{{ old('username') }}">
                    @error('username')
                    <p class="text-red-500 font-semibold">{{ $message }}</p>
                    @enderror
                </div>
